...
public class JenaPersistenceFactory {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JenaPersistenceFactory.class);
    ...
    @Autowired
    public JenaPersistenceFactory(Environment environment, SchemaExporter schemaExporter) {
...
//        props.put(OntoDriverProperties.REASONER_FACTORY_CLASS, RDFSRuleReasonerFactory.class.getName());
        ...
        props.put(JOPAPersistenceProperties.SCAN_PACKAGE, "cz.cvut.kbss.jopa.multipleinheritancedemo.model");
        // Ontology language
